...
<div className="flex flex-wrap row-auto items-end">
                <h1 className=" mb-6 max-w-[700px] leading-snug dark:text-white text-8xl sm:leading-snug lg:text-9xl lg:leading-[1.2]">
        ...
        {/* <div className="absolute -left-20 bottom-0 z-[-1]">
                  <svg
                    width="134"
                    height="106"
                    viewBox="0 0 134 106"
