              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base font-mono text-body-color dark:text-dark-6">
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-base font-mono text-body-color dark:text-dark-6">
              ...
              <form>
                <div className="mb-[22px]">
                  ...
                  <input
                    ...
                    name="fullName"
                    placeholder="Max"
                    className="w-full font-mono border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-primary focus:outline-none dark:border-dark-3 dark:text-dark-3"
                  />
                </div>
                <div className="mb-[22px]">
                  <label
                  ...
                  <input
                    ...
                    className="w-full font-mono border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-primary focus:outline-none dark:border-dark-3 dark:text-white"
                  />
                </div>
                <div className="mb-[22px]">
                  <label
                ...
                <div className="mb-[30px]">
                  ...
                  <textarea
                    ...
                    className="w-full font-mono resize-none border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color focus:border-primary focus:outline-none dark:border-dark-3 dark:text-white"
                  ></textarea>
                </div>
                <div className="mb-0">
                  <button
