...
const SingleTeam = ({ team }: { team: TeamType }) => {
  ...
  return (
    <div className="w-full px-4 lg:w-1/2 xl:w-1/2">
      <div className="group mx-4 mb-8 bg-black px-5 pb-12 shadow-testimonial dark:bg-white dark:shadow-none">
        <div className="relative z-10 mx-auto mb-5 h-[480px] w-[120px]">
          <h3 className="mb-1 align-bottom text-lg font-normal text-dark dark:text-black">
            {name}
          </h3>
