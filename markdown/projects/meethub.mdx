...
excerpt: A SaaS platform empowering event hosts to seamlessly sell tickets, manage attendees, and streamline event operations—all from their own website.
date: 
coverImage: /images/blog/meethub.png
author: meethub
authorImage: /images/blog/author.jpg
deliverables : ["-ui/ux design", "-saas development", "-dashboard development", "-branding/identity", "-web development"]
client: meethub
industry: event ticket e-commerce
---
